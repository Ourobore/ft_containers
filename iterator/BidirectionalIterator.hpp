...
/*   Updated: 2021/09/07 13:54:59 by lchapren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T>
BidirectionalIterator<T>::BidirectionalIterator() : _it(NULL)
{
}

template <typename T>
BidirectionalIterator<T>::BidirectionalIterator(pointer p) : _it(p)
{
}

template <typename T>
BidirectionalIterator<T>::BidirectionalIterator(const BidirectionalIterator& rhs) : _it(rhs._it)
{
}
