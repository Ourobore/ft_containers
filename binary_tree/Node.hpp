...
/*   Updated: 2022/01/07 16:06:52 by lena             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct BaseNode
{
    ...
    void set_left(BaseNode* left)
    {
        _left = left;
        _left->set_parent(this);
    }

    void set_right(BaseNode* right)
    {
        _right = right;
...
template < class T >
Node< T >::Node()
    : BaseNode<T>(), _data(value_type())
{
}

template < class T >
Node< T >::Node(const_reference value)
    : BaseNode<T>(), _data(value)
{
}
